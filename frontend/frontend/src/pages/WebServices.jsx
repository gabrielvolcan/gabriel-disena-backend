    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span>→</span>
          <span style={{ color: '#3b82f6', fontWeight: 'bold' }}>Desarrollo Web</span>
        </div>
      ...
      <div id="contacto" style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            ¿Listo para tener presencia en internet?
          </p>
          <button 
            onClick={() => {
              const message = 'Hola! Estoy interesado en solicitar un presupuesto para un sitio web. ¿Podrías ayudarme?';
              const whatsappUrl = `https://wa.me/51957949278?text=${encodeURIComponent(message)}`;
              window.open(whatsappUrl, '_blank');
            }}
            style={{
